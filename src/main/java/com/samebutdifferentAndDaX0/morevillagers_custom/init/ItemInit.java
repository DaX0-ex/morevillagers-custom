...
public class ItemInit {
    ...
    public static final RegistryObject<BlockItem> INVENTOR_TABLE = ITEMS.register("inventor_table",
            () -> new BlockItem(BlockInit.INVENTOR_TABLE.get(), new Item.Properties().tab(MoreVillagers.GROUP)));
}
